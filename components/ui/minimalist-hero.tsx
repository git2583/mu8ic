    ...
    >
      ...
      <header className="z-30 flex w-full max-w-7xl items-center justify-between">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <motion.a
            ...
            className="rounded-md bg-blue-600 px-12 py-3 text-base font-light text-white transition-all hover:bg-blue-700"
          >
            {ctaText}
          </motion.a>
        </div>
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        >
          ...
          <a
            href={ctaLink}
            className="mt-6 inline-block rounded-md bg-blue-600 px-12 py-3 text-base font-light text-white transition-all hover:bg-blue-700"
          >
            {ctaText}
          </a>
        </motion.div>
