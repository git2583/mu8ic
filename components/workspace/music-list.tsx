...
import { PlayCircle, PauseCircle, Download, Trash2, Loader2, Music, CheckCircle2, MoreVertical, Edit3 } from "lucide-react";
...
export function MusicList({ musics, onDelete, onPlay, onRename, playingTrackId, generationStatus = 'idle', errorMessage }: MusicListProps) {
                        ...
                        >
                          ...
                          <button
                            onClick={(e) => {
                              ...
                              if (window.confirm("정말 이 음악을 삭제하시겠습니까? 관련 파일도 모두 삭제됩니다.")) {
